...
class ErrorParserTest {
    ...
    @Test
    fun `parse CDO backend error - NOT_FOUND`() {
    ...
    @Test
    fun `parse CDO backend error - AUTH_INVALID_CREDENTIALS`() {
    ...
    @Test
    fun `parse CDO backend error - missing error message uses errorCode`() {
    ...
    @Test
    fun `parse CDO backend error - missing both error and errorCode`() {
    ...
    @Test
    fun `parse CDO backend success should NOT be treated as error`() {
        ...
        val error = parseApiError(body, 400)
        // Since success=true, it skips CDO handler and falls through
        assertEquals(400, error.code)
    }
