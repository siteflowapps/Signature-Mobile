...
import com.siteflow.cdo.core.data.auth.AuthInterceptor
import com.siteflow.cdo.core.data.auth.TokenRefreshManager
...
val networkModule = module {
    ...
    single {
        AuthRepository(get()).also { authRepo ->
            ...
            // 🌍 Load persisted environment — defaults to PROD if none saved
            val tokenStorage = get<com.siteflow.cdo.core.data.auth.TokenStorage>()
