...
import com.siteflow.cdo.core.analytics.AnalyticsParams
        ...
        scope.launch {
            ...
            repository.verifyOtp(
                ...
                .onSuccess { tokenData ->
                    ...
                    val businessId = com.siteflow.cdo.core.data.networking.util.JwtUtils.extractBusinessId(tokenData.accessToken)
                    ...
                    val role = try {
                        ...
                        com.siteflow.cdo.core.data.networking.util.JwtUtils.extractRole(tokenData.accessToken)
                    }
