...
import com.siteflow.cdo.core.presentation.components.state.OutletListSkeleton
...
fun AseDashboardScreen(
    ...
    Column(
        ...
        Column(modifier = Modifier.padding(horizontal = 20.dp)) {
            ...
            CdoListHeader(label = "OUTLETS ($headerCount)")
