...
import com.siteflow.cdo.ase.onboarding.data.dto.BusinessDetailsRequestDto
import com.siteflow.cdo.ase.onboarding.data.dto.CreateOutletRequestDto
import com.siteflow.cdo.ase.onboarding.data.dto.DistributorDto
import com.siteflow.cdo.ase.onboarding.data.dto.LocationDto
import com.siteflow.cdo.ase.onboarding.data.dto.OutletListPageDto
import com.siteflow.cdo.ase.onboarding.data.dto.OutletResponseData
import com.siteflow.cdo.ase.onboarding.data.dto.SlabDto
import com.siteflow.cdo.ase.onboarding.data.dto.KycDetailsRequestDto
import com.siteflow.cdo.ase.onboarding.domain.OnboardingState
...
import com.siteflow.cdo.core.util.CdoLog
import com.siteflow.cdo.core.util.ImageEncoder
...
class OutletRepository(
    ...
    suspend fun submitBusinessDetails(
        ...
        val isFixed = state.payoutType == com.siteflow.cdo.ase.onboarding.domain.PayoutType.FIXED
        val isBankMode = state.bankPaymentMode == com.siteflow.cdo.ase.onboarding.domain.BankPaymentMode.BANK
    ...
    suspend fun requestAsset(
        ...
        val request = com.siteflow.cdo.ase.onboarding.data.dto.AssetRequestDto(
    ...
    suspend fun submitCompliance(
        ...
        CdoLog.d("CDO-Repo", "┌── Submit Compliance ─────────────────")
        CdoLog.d("CDO-Repo", "│ outletId        : $outletId")
        CdoLog.d("CDO-Repo", "│ coolerInstalled : $coolerInstalled")
        CdoLog.d("CDO-Repo", "│ serialNo        : $serialNo")
        CdoLog.d("CDO-Repo", "│ coolerType      : $coolerType")
        CdoLog.d("CDO-Repo", "│ capacity        : $capacity")
        CdoLog.d("CDO-Repo", "│ signageInstalled: $signageInstalled")
        CdoLog.d("CDO-Repo", "└──────────────────────────────────────")

        val dto = com.siteflow.cdo.ase.onboarding.data.dto.ComplianceRequestDto(
        ...
        CdoLog.d("CDO-Repo", "┌── Compliance Photo Sizes ────────────")
        CdoLog.d("CDO-Repo", "│ coolerImage      : ${coolerBytes.size} B  (~${coolerBytes.size / 1024} KB)")
        CdoLog.d("CDO-Repo", "│ assetLabelImage  : ${assetLabelBytes.size} B  (~${assetLabelBytes.size / 1024} KB)")
        CdoLog.d("CDO-Repo", "│ signageImage     : ${signageBytes.size} B  (~${signageBytes.size / 1024} KB)")
        CdoLog.d("CDO-Repo", "│ outerOutletImage : ${outerBytes.size} B  (~${outerBytes.size / 1024} KB)")
        CdoLog.d("CDO-Repo", "│ innerOutletImage : ${innerBytes.size} B  (~${innerBytes.size / 1024} KB)")
        CdoLog.d("CDO-Repo", "│ ─────────────────────────────────────")
        CdoLog.d("CDO-Repo", "│ TOTAL PAYLOAD    : ${totalBytes} B  (~${totalBytes / 1024} KB)")
        CdoLog.d("CDO-Repo", "└──────────────────────────────────────")
