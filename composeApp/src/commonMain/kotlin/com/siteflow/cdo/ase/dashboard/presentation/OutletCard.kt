...
/**
 * Reusable outlet card with left color bar and CDO pipeline progress.
 */
@Composable
fun OutletCard(
    outlet: OutletItem,
    ...
    Card(
        ...
        Row(modifier = Modifier.fillMaxWidth().height(IntrinsicSize.Min)) {
            ...
            Column(
                ...
                // Onboarding Progress
                CdoPipelineRow(outlet.completedSteps)
...
/**
 * Mini CDO pipeline progress — 5 step dots with check/empty indicators.
 */
@Composable
private fun CdoPipelineRow(completedSteps: Set<CdoStep>) {
    Row(
        modifier = Modifier.fillMaxWidth(),
        verticalAlignment = Alignment.CenterVertically,
        ...
        Text(
            text = "${completedSteps.size}/${CdoStep.entries.size}",
            style = AppTypography.Caption.copy(
                fontSize = 10.sp,
        ...
        LinearProgressIndicator(
            progress = { completedSteps.size.toFloat() / CdoStep.entries.size },
            modifier = Modifier
                .weight(1f)
                .height(4.dp),
            color = AppColors.Success,
