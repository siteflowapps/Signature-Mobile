...
import com.siteflow.cdo.core.domain.PdfCompressionResult
...
import com.siteflow.cdo.outlet.invoices.data.InvoiceItemDto
import com.siteflow.cdo.outlet.invoices.data.InvoiceSummary
import com.siteflow.cdo.outlet.invoices.data.InvoiceUploadRequestDto
import com.siteflow.cdo.outlet.invoices.data.OcrInvoiceData
        ...
        viewModelScope.launch {
            ...
            when (val result = pdfCompressor.compress(bytes)) {
                is PdfCompressionResult.Success -> {
                    val preview = com.siteflow.cdo.outlet.invoices.domain.PdfPreviewData(
                        filename = filename,
                ...
                is PdfCompressionResult.Failure.TooManyPages -> {
                    ...
                    emitEvent(
                        UploadInvoiceEvent.PdfTooManyPages(
                            ...
                            max = com.siteflow.cdo.core.domain.PdfCompressorConstants.MAX_PAGES,
                        )
                    )
                }
        ...
        viewModelScope.launch {
            try {
                val file = pdfFile ?: run {
                    ...
                    com.siteflow.cdo.outlet.invoices.domain.InvoiceFile.jpeg(photoBytes)
                }
